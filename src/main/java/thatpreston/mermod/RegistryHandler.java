...
public class RegistryHandler {
    ...
    public static final RegistryObject<Item>
            ...
            SEA_CRYSTAL = ITEMS.register("sea_crystal", () -> new Item(new Item.Properties())),
    ...
    public static RegistryObject<RecipeSerializer<NecklaceModifierRecipe>> NECKLACE_MODIFIER_SERIALIZER = RECIPES.register("crafting_special_necklace_modifier", () -> new SimpleCraftingRecipeSerializer<>(NecklaceModifierRecipe::new));
